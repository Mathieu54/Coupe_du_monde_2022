...
final class Version20221130110024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bet_podium (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, podium_countrie_id INT NOT NULL, first_countrie_user_id INT NOT NULL, second_countrie_user_id INT NOT NULL, third_countrie_user_id INT NOT NULL, calculation TINYINT(1) NOT NULL, INDEX IDX_5FA29314A76ED395 (user_id), INDEX IDX_5FA29314624CC32D (podium_countrie_id), INDEX IDX_5FA29314412FDD38 (first_countrie_user_id), INDEX IDX_5FA293144F0D1DAB (second_countrie_user_id), INDEX IDX_5FA2931472A7317A (third_countrie_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
